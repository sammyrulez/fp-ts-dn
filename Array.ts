...
import { Foldable2v1 }  from  './Foldable2v.ts'
import { identity, Lazy, not, Predicate, Refinement, toString }  from  './function.ts'
import { HKT }  from  './HKT.ts'
import { Monad1 }  from  './Monad.ts'
import { getDualMonoid, Monoid }  from  './Monoid.ts'
import { Ord, fromCompare }  from  './Ord.ts'
...
export class None<A> {
   ...
   *
   * @example
   * import { Option, none, some }  from  'fp-ts/lib/Option.ts'
   *
...
/**
 * @example
 * import { none, some, getSetoid }  from  'fp-ts/lib/Option.ts'
 * import { setoidNumber }  from  'fp-ts/lib/Setoid.ts'
 *
 * const S = getSetoid(setoidNumber)
 ...
 *
 * @example
 * import { none, some, fromEither }  from  'fp-ts/lib/Option.ts'
 * import { left, right }  from  'fp-ts/lib/Either.ts'
 *
...
import { HKT, Type, Type2, Type3, URIS, URIS2, URIS3 }  from  './HKT.ts'
import { Magma }  from  './Magma.ts'
import { getDictionaryMonoid, Monoid }  from  './Monoid.ts'
import { none, Option, some as optionSome }  from  './Option.ts'
import { Semigroup }  from  './Semigroup.ts'
import { fromEquals, Setoid }  from  './Setoid.ts'
import { Unfoldable, Unfoldable1 }  from  './Unfoldable.ts'
 ...
 *
 * @example
 * import { reduce }  from  'fp-ts/lib/Record.ts'
 *
...
import { Filterable2C }  from  './Filterable.ts'
import { Foldable2v2 }  from  './Foldable2v.ts'
import { phantom, Predicate, toString, Refinement, Lazy }  from  './function.ts'
import { Functor2 }  from  './Functor.ts'
import { HKT }  from  './HKT.ts'
import { Monad2C }  from  './Monad.ts'
import { Monoid }  from  './Monoid.ts'
...
/**
 * @example
 * import { Validation, getApplicative, success, failure }  from  'fp-ts/lib/Validation.ts'
 * import { NonEmptyArray, getSemigroup }  from  'fp-ts/lib/NonEmptyArray.ts'
 *
 * interface Person {
...
/**
 * @example
 * import { Validation, success, failure, getApplicative }  from  'fp-ts/lib/Validation.ts'
 * import { getArraySemigroup }  from  'fp-ts/lib/Semigroup.ts'
 *
 * interface Person {
 *   name: string
 *   age: number
 ...
 *
 * @example
 * import { Validation, failure, success, tryCatch }  from  'fp-ts/lib/Validation.ts'
 *
 * const unsafeHead = <A>(as: Array<A>): A => {
 *   if (as.length > 0) {
 *     return as[0]
...
import { Foldable2v1 }  from  './Foldable2v.ts'
import { FoldableWithIndex1 }  from  './FoldableWithIndex.ts'
import { concat, Endomorphism, identity, Predicate, Refinement, tuple }  from  './function.ts'
import { FunctorWithIndex1 }  from  './FunctorWithIndex.ts'
import { HKT, Type, Type2, Type3, URIS, URIS2, URIS3 }  from  './HKT.ts'
import { Monad1 }  from  './Monad.ts'
import { Monoid }  from  './Monoid.ts'
import { none, Option, some }  from  './Option.ts'
import { getSemigroup, Ord, ordNumber, fromCompare }  from  './Ord.ts'
import { Plus1 }  from  './Plus.ts'
import { getArraySetoid, Setoid }  from  './Setoid.ts'
import { TraversableWithIndex1 }  from  './TraversableWithIndex.ts'
import { Unfoldable1 }  from  './Unfoldable.ts'
import { Witherable1 }  from  './Witherable.ts'
import { NonEmptyArray }  from  './NonEmptyArray2v.ts'
import { Show }  from  './Show.ts'
 ...
 * import { getSetoid }  from  'fp-ts/lib/Array.ts'
 *
 ...
 *
 * @example
 * import { takeEnd }  from  'fp-ts/lib/Array.ts'
 *
 ...
 *
 * @example
 * import { dropEnd }  from  'fp-ts/lib/Array.ts'
 *
 ...
 * @example
 * import { sortBy1 }  from  'fp-ts/lib/Array.ts'
 * import { contramap, ordString, ordNumber }  from  'fp-ts/lib/Ord.ts'
 *
 * interface Person {
 *   name: string
 ...
 *
 * @example
 * import { mapOption }  from  'fp-ts/lib/Array.ts'
 * import { Option, some, none }  from  'fp-ts/lib/Option.ts'
 *
 ...
 *
 * @example
 * import { catOptions }  from  'fp-ts/lib/Array.ts'
 * import { some, none }  from  'fp-ts/lib/Option.ts'
 *
 ...
 *
 * @example
 * import { Setoid, setoidNumber }  from  'fp-ts/lib/Setoid.ts'
 ...
 *
 * @example
 * import { split }  from  'fp-ts/lib/Array.ts'
 *
